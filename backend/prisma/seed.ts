...
const permissions = ['dashboard.view','agenda.view','vehicles.view','orders.view','finance.view','crm.view','yard.view','tools.view','settings.manage','tenant.read','tenant.write']
const companies = [
