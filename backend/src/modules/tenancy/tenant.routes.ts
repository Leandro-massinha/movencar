...
tenantRouter.get(
  ...
  asyncHandler(async (req, res) => {
    res.json({
      resources: await prisma.tenantTestResource.findMany({
...
tenantRouter.post(
  ...
  asyncHandler(async (req, res) => {
    const input = z
      ...
      .parse(req.body);
    const resource = await prisma.tenantTestResource.create({
      data: {
...
tenantRouter.get(
  ...
  requirePermission("tenant.read"),
  asyncHandler(async (req, res) => {
    const resource = await prisma.tenantTestResource.findFirst({
