...
const demoUser: User = { id: 'usr-1', name: 'Marina Costa', email: 'marina@movencar.demo', role: 'Administrador', permissions: ['dashboard.view','agenda.view','vehicles.view','orders.view','finance.view','crm.view','yard.view','tools.view','settings.manage'] }
