...
describe('frontend module access',()=>{
  it('maps permissions to their commercial module',()=>{expect(moduleForPermission('customers.create')).toBe('customers');expect(moduleForPermission('vehicles.view')).toBe('vehicles');expect(moduleForPermission('vehicle_history.view')).toBe('vehicles');expect(moduleForPermission('vehicle_history.create')).toBe('vehicles');expect(moduleForPermission('settings.manage')).toBe('core')})
