export type Permission = 'dashboard.view' | 'agenda.view' | 'vehicles.view' | 'orders.view' | 'finance.view' | 'crm.view' | 'yard.view' | 'tools.view' | 'settings.manage' | 'customers.view' | 'customers.create' | 'customers.update' | 'customers.delete'
